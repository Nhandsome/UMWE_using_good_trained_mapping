...
def build_model(params, with_dis):
    ...
    # HAN 
    # GOOD mappings (src1 to src2) 
        for src_lang, tgt_lang in itertools.permutations(params.src_langs, 2):
            print(f'{src_lang}_{tgt_lang}')
            mappings[f'{src_lang}_{tgt_lang}'] = nn.Linear(params.emb_dim, params.emb_dim, bias=False)
