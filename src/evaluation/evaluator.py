...
from . import get_word_translation_accuracy, get_word_translation_accuracy_n
...
class Evaluator(object):
    ...
    def crosslingual_wordsim_m(self, to_log, src_lang=None, tgt_lang=None, mid_lang=None):
        """
        Evaluation on cross-lingual word similarity.
        If src_lang and tgt_lang are not specified, evaluate all src_langs to tgt_lang
        """
        ...
        if src_lang is None and tgt_lang is None:
            ...
            assert src_lang is not None and tgt_lang is not None
            # encode src
            t_src_emb = apply_mapping(self.mappings[src_lang],
                    self.embs[src_lang].weight)
            
            src_emb = apply_mapping(self.mappings[mid_lang],
                    t_src_emb).cpu().numpy()
    ...
    def crosslingual_wordsim_mm(self, to_log, src_lang=None, tgt_lang=None, mid_lang=None):
        """
        Evaluation on cross-lingual word similarity.
        If src_lang and tgt_lang are not specified, evaluate all src_langs to tgt_lang
        """
    ...
    def word_translation_mm(self, to_log, src_lang=None, tgt_lang=None, mid_lang=None,temp=None):
        """
        ...
        if src_lang is None and tgt_lang is None:
            ...
            src_emb_1 = apply_mapping(self.mappings[mid_lang],
                t_src_emb)

            src_emb_2 = apply_mapping(self.mappings['ori'],
                self.embs[src_lang].weight)
            # print('ori')
            
            temp = temp
            logger.info(f'Pivot : {temp}')
            src_emb_1 = src_emb_1*temp
            src_emb_2 = src_emb_2*(1-temp)

            src_emb = src_emb_1.add(src_emb_2).cpu()
    ...
    def word_translation_m(self, to_log, src_lang=None, tgt_lang=None, mid_lang=None):
        """
        Evaluation on word translation.
        If src_lang and tgt_lang are not specified, evaluate all src_langs to tgt_lang
        """
...
## Nhand
    def word_translation_n(self, to_log, src_lang=None, tgt_lang=None):
        """
        Evaluation on word translation.
        If src_lang and tgt_lang are not specified, evaluate all src_langs to tgt_lang
        """
        ...
        if src_lang is None and tgt_lang is None:
            ...
            for src_lang in self.params.src_langs:
                ...
                for method in ['nn', 'csls_knn_10']:
                    results = get_word_translation_accuracy_n(
                        src_lang, self.vocabs[src_lang].word2id, src_emb,
                        tgt_lang, self.vocabs[tgt_lang].word2id, tgt_emb,
                        method=method, dico_eval=self.params.dico_eval
                    )
    ...
    def sent_translation(self, to_log, src_lang=None, tgt_lang=None):
        ...
        if src_lang is None and tgt_lang is None:
            ...
            for method in ['nn', 'csls_knn_10']:
                ...
                to_log.update([('%s_to_%s_%s-%s' % (src_lang, tgt_lang, k, method), v) for k, v in results])
# **Seed_share
    def dist_mean_cosine_mm(self, to_log, temp):
        """
        Mean-cosine model selection criterion.
        """
        # all pair refine
        mid_lang = self.params.mid_lang
        mean_cosines = []
        for i, src_lang in enumerate(self.params.src_langs):
            ...
            for j in range(i+1, len(self.params.all_langs)):
                ...
                src_emb = src_emb_1.add(src_emb_2)
